...
<input type="hidden" name="day" />
	<table class="table-line">
	 <thead>
	  <tr>
	    <th class="title" style="width:36px;" colspan="1">
	    ...
	    <th class="title" style="width:108px;" colspan="3">${resultList[0].year}년${resultList[0].month}월</th>
	    <th class="title" style="width:36px;" colspan="1">
	  ...
	  <tr>
	    <th class="title" style="width:36px;">일</th>
	    <th class="title" style="width:36px;">월</th>
	    <th class="title" style="width:36px;">화</th>
	    <th class="title" style="width:36px;">수</th>
	    <th class="title" style="width:36px;">목</th>   
	    <th class="title" style="width:36px;">금</th>
	    <th class="title" style="width:36px;">토</th>         
	  </tr>
	 </thead>    
	 <tbody>
		<tr>
