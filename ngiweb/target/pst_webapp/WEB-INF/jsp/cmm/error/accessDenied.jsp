        ...
        <td style="text-align:center;"><table style="width:100%;border:0px;border-spacing:0px;">
          <tr>
            <td style="background-color:#FFFFFF;"><table style="width:100%;border:0px;border-spacing:0px;">
              <tr>
                <td style="text-align:left;"><img src="<c:url value='/images/egovframework/com/cmm/er_logo.jpg' />" width="379" height="57" alt="로고" /></td>
              </tr>
              <tr>
                <td><br />
                  <br /></td>
              ...
              <tr>
                <td style="text-align:center;"><table style="width:520px;border:0px;border-spacing:0px;">
                  <tr>
                    <td style="width:74px;text-align:center;"><img src="<c:url value='/images/egovframework/com/cmm/danger.jpg' />" width="74" height="74" alt="경고"/></td>
                    <td style="width:399px;text-align:left;" class="lt_text2">세션이 만료되었습니다.</td>
                  </tr>
                </table>
