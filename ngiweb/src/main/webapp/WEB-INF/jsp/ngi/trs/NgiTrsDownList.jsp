...
jQuery(document).ready(function(){
	...
	jQuery("#searchCondition").val(searchCon);
        ...
        <div class="remark_right">
	        <label for="searchCondition">선택</label>
		        <form:select path="searchCondition" name="searchCondition" id="searchCondition" class="AXSelectSmall">
	                   <form:option value="00" selected="selected" >세움터</form:option>
	                   <form:option value="01">새주소</form:option>
			    </form:select>
            <button type="button" class="AXButtonSmall Blue" onClick="javascript:fn_c.init('실행');"><i class="fa fa-search fa-1"></i> 검색</button>&nbsp;
        </div>
    </div>
	<!-- List -->
