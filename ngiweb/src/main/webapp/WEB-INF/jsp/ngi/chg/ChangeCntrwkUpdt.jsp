		...
		<table align="center" cellpadding="3" cellspacing="3"  class="tabSwrite3">
			...
			<tr>
				...
				<c:choose>
					...
					<a href="#" id="regAddrAddLine"><img src="<c:url value='/'/>images/map/mmenu_line.png" alt="선그리기" ></a>
					<a href="#" id="regAddrAddPolygon"><img src="<c:url value='/'/>images/map/mmenu_side.png" alt="면그리기" ></a>
				</td>
			</tr>	
			<tr>
				<th>공사시점</th>
