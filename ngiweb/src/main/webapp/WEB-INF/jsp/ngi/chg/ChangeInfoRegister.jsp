...
<c:set var="registerFlag" value="등록"/>
...
function fn_egov_save() {	
    ...
    if (document.detailForm.changeSj.value =="") {
    	...
    	//jQuery('[name="sttemntCn"]').val(sttemntCn);	
	  	...
	  	frm.action = "/ngiweb/ngi/chg/addChangeInfo.do";
		frm.submit();
    }
}
...
<div id="content_pop">
	...
	<table align="center" cellpadding="3" cellspacing="3"  class="tabSwrite">
		...
		<tr>
			<th>신고자명</th>
			<td colspan="3">
				<%-- <form:input path="registerNm" class="AXInput W100" value='<%=session.getAttribute("sUserNm")%>' />
				&nbsp;<form:errors path="registerNm" /> --%>
				<form:input path="registerNm" class="AXInput W100" value='이경민' />
				&nbsp;<form:errors path="registerNm" />
			</td>
		</tr>	
		<tr>
			<th>전화번호</th>
			<td>
				<%-- <form:input path="telno" class="AXInput W100" value='<%=session.getAttribute("sUserTel")%>' />
				&nbsp;<form:errors path="telno" /> --%>
				<form:input path="telno" class="AXInput W100" value='010-2599-6527' />
				&nbsp;<form:errors path="telno" />
			</td>
			
			<th>전자우편</th>
			<td>
				<%-- <form:input path="email" class="AXInput W100" value='<%=session.getAttribute("sUserEmail")%>' />
				&nbsp;<form:errors path="email" /> --%>
				<form:input path="email" class="AXInput W100" value='hert6527@naver.com' />
				&nbsp;<form:errors path="email" />
			</td>			
		</tr>	
		<tr>
				...
				<br />
					<div id="BtnAreaMap">
						<div id="StyleButtonDivMap" style="padding-right:0pt;margin:2pt;">
							...
							&nbsp;&nbsp;
							<button type="button" class="AXButtonSmall Blue" id="regAddrSearch">주소검색</button> 
							<button type="button" class="AXButtonSmall Blue" id="regAddrPoint">위치입력</button> 
...
<c:if test="${not empty changeSttemntInfoVO.atchFileId}">
	...
	<div class="MapMarg_T30">
		<div id="BtnAreaMap">
			...
			<button type="button" class="AXButtonSmall Blue" OnClick="javascript:fn_egov_save();"><i class="fa fa-pencil fa-lg"></i> <c:out value='${registerFlag}'/></button>				
...
function fn_egov_login() {
	...
	top.location.href = "<c:url value='/'/>redirect2.jsp";
}
...
<div id="content_pop">
	...
	<table align="center" cellpadding="3" cellspacing="3"  class="tabSwrite">
		...
		<tr>
			<th>신고자명</th>
			<td colspan="3">
				<input name="registerNm" class="AXInput W100" OnClick="javascript:fn_egov_login();" />
			</td>
		</tr>	
		<tr>
			<th>전화번호</th>
			<td>
				<input name="telno" class="AXInput W100" OnClick="javascript:fn_egov_login();"   />
			</td>
			
			<th>전자우편</th>
			<td>
				<input name="email" class="AXInput W100"  OnClick="javascript:fn_egov_login();"   />
			</td>			
		</tr>	
		<tr>
		...
		<tr>
			<th>신고제목</th>
			<td>
				<input name="changeSj" class="AXInput W100"  OnClick="javascript:fn_egov_login();"  />
			</td>
			<th>유형</th>
			<td>
	           <form:select path="sttemntTy" id="sttemntTy" class="AXSelectSmall"  OnClick="javascript:fn_egov_login();" >
                   <form:option value="">-선택-</form:option>
                   <form:options items="${sttemntty_result}" itemValue="code" itemLabel="codeNm"/>
               </form:select>			
			</td>			
		...
		<tr>
			<th>변동지 주소</th>
			<td colspan="3">
 				<form:input path="changeRnAdresCn" class="AXInput W300"  OnClick="javascript:fn_egov_login();"  />(도로명)
				&nbsp;<form:errors path="changeRnAdresCn" /><br /><br />
 				<form:input path="changeLnmAdresCn" class="AXInput W300" OnClick="javascript:fn_egov_login();" />(지번)
				&nbsp;<form:errors path="changeLnmAdresCn" />				
				<br />
					<div id="BtnAreaMap">
						<div id="StyleButtonDivMap" style="padding-right:0pt;margin:2pt;">
	...
	<div class="MapMarg_T30">
		<div id="BtnAreaMap">
			<div id="StyleButtonDivMap">
			<button type="button" class="AXButtonSmall Blue" OnClick="javascript:fn_egov_login();"><i class="fa fa-pencil fa-lg"></i> <c:out value='${registerFlag}'/></button>				
			<button type="button" class="AXButtonSmall Blue" OnClick="javascript:fn_egov_cancel();"><i class="fa fa-align-justify fa-lg"></i> 목록</button>
			</div>
		</div>
	</div>
