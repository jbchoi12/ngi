...
<div class="Subcontainer">
    ...
    <h2>서비스</h2>
        <ul class="side1_ul">
        <li  class="side1_li"><a href="<c:url value='/'/>main/NgiNotification.do" class="side1_aon">법적고지</a></li>
        <li  class="side1_li"><a href="<c:url value='/'/>main/NgiServiceTerms.do" class="side1_a">이용약관</a></li>
        <li  class="side1_li"><a href="<c:url value='/'/>main/NgiPrivacyInfo.do" class="side1_a">개인정보처리방침</a></li>
        </ul>
