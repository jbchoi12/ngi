...
function fn_egov_initl_qnacn(){
	...
	// 첫 입력란에 포커스..
	qnaManageVO.writngPssword.focus();
    ...
    <div class="ConMView">
            ...
            <div class="search_service">
                <div class="search_top_table">
					<table summary="Q&amp;A에 대한 정보를 등록합니다." class="tabwrite">
					<caption>Q&amp;A내용등록</caption>
					  <tr> 
					    <th class="td_width"><label for="wrterNm">작성자명</label><img src="<c:url value='/'/>images/required.gif" alt="필수항목" title="필수항목" width="15" height="15"/></th>
					    <td class="td_content">
					  ...
					  <tr> 
					    <th class="td_width"><label for="writngPssword">작성 비밀번호</label><img src="<c:url value='/'/>images/required.gif" alt="필수항목" title="필수항목" width="15" height="15"/></th>
					    <td class="td_content">
					        <form:password path="writngPssword"  class="AXInput W100" maxlength="20"  title="작성 비밀번호"/>
					        <div><form:errors path="writngPssword"/></div>                       
					    </td>
					  </tr>
					    
				  
					  <tr> 
					    <th class="td_width"><label for="qestnSj">질문제목</label><img src="<c:url value='/'/>images/required.gif" alt="필수항목" title="필수항목" width="15" height="15"/></th>
					    <td class="td_content">       
					  ...
					  <tr> 
					    <th class="td_width"><label for="qestnCn">질문내용</label><img src="<c:url value='/'/>images/required.gif" alt="필수항목" title="필수항목" width="15" height="15"/></th>
					    <td class="td_content">     
					      <form:textarea path="qestnCn" cols="75" rows="20" cssClass="txaClass"  title="질문내용"/>   
                ...
                <div class="Marg_T10">
			        <div id="BtnAreaSub">
			            <div id="StyleButtonDivSub">
			                ...
			                <button type="button" onclick="fn_egov_regist_qnacn(document.qnaManageVO);"  class="AXButtonSmall Blue" ><i class="fa fa-pencil fa-lg"></i> 등록</button>
