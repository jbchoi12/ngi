...
function fn_egov_initl_qnacn(){
	...
	// 작성글 비밀번호 입력란에 포커스..
	document.QnaManageForm.writngPssword.focus();
...
function fn_egov_confirm_qnapassword(){
	...
	//  현재화면의 작성 비밀번호
	var	ls_writngPssword = document.QnaManageForm.writngPssword.value;
	
	// 부모화면으로 작성비밀번호를 넘긴다.
	opener.document.QnaManageForm.writngPssword.value = ls_writngPssword;	
...
<caption>작성 비밀번호 확인</caption>
  <tr> 
    <th scope="row" width="45%" height="23" class="required_text" nowrap ><label for="writngPssword">작성글 비밀번호</label>
    </th>
    <td width="55%" nowrap="nowrap">
    	<input name="writngPssword" type="password"  class="AXInput W100"  value="" maxlength="20" title="작성글 비밀번호">  
    </td>
  </tr>
</table>
<!-- 목록/저장버튼  시작-->
            ...
            <div class="buttons" align="center" style="margin-bottom:100px">
	            <button type="button" class="AXButtonSmall Blue" onClick="javascript:fn_egov_confirm_qnapassword();"><i class="fa fa-check-circle fa-lg"></i> 확인</button>
				<button type="button" class="AXButtonSmall Blue" onClick="javascript:fn_egov_cancel_qnapassword();"><i class="fa fa-times fa-lg"></i> 취소</button>
            </div>
            </td></tr></table>
            <!-- 목록/저장버튼  끝-->
</form>
