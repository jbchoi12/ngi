...
Heatmap.Layer = OpenLayers.Class(OpenLayers.Layer, {
  ...
  initialize: function(name, options) {
    ...
    this.setGradientStops({
        0.00: 0xffffff00,	//0x0f809800,	//0xffffff00,	
        0.05: 0x0f809800,	//----------,	//0x006837ff,	
        0.10: 0x099466ff,	//0x099466ff,	//0x006837ff,	
        0.20: 0x42b75cff,	//0x42b75cff,	//0x1a9850ff,	
        0.30: 0x81d852ff,	//0x81d852ff,	//0x66bd63ff,	
        0.30: 0xc3f25cff,	//0xc3f25cff,	//0xa6d96aff,	
        0.40: 0xf7e85cff,	//0xf7e85cff,	//0xd9ef8bff,	
        0.50: 0xf7ca5cff,	//0xf7ca5cff,	//0xfee08bff,	
        0.60: 0xf2a942ff,	//0xf2a942ff,	//0xfdae61ff,	
        0.70: 0xf18034ff,	//0xf18034ff,	//0xf46d43ff,	
        0.80: 0xee6349ff,	//0xee6349ff,	//0xd73027ff,	
        0.90: 0xe03932ff,	//0xe03932ff,	//0xa50026ff,	
        0.99: 0xd10b1dff,	//0xd10b1dff,	//0xaa0000ff,	
        1.00: 0xaa0023ff	//0xaa0023ff	//0x000000ff	
    });
...
//    for (var i in this.points) {
    for(var i=0;i<this.points.length;i++) {
      ...
      if (isNaN(src.lonlat.lon) || isNaN(src.lonlat.lat)) continue;
