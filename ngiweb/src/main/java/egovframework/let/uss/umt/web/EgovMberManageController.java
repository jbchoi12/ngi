...
public class EgovMberManageController {
    ...
    public String updatePassword(ModelMap model,
								 @CommandMap Map<String, Object> commandMap,
    		  					 ...
    		  					 @ModelAttribute("mberManageVO") MberManageVO mberManageVO)
    							throws Exception {
    	String oldPssword = (String)commandMap.get("oldPassword");
        ...
        mberManageVO.setPssword(newPassword);
        mberManageVO.setOldPssword(oldPssword);
        mberManageVO.setUniqId(uniqId);

    	String resultMsg = "";
    	resultVO = mberManageService.selectPassword(mberManageVO);
    	//패스워드 암호화
		String encryptPass = EgovFileScrty.encryptPassword(oldPssword);
    	if (encryptPass.equals(resultVO.getPssword())){
    	...
    	if (isCorrectPassword){
    		mberManageVO.setPssword(EgovFileScrty.encryptPassword(newPassword));
