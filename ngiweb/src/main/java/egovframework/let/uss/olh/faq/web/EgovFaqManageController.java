...
public class EgovFaqManageController {
    ...
    @RequestMapping(value="/uss/olh/faq/FaqListInqireJson.do")
	@ResponseBody
    public void selectFaqListJson(@ModelAttribute("searchVO") FaqManageDefaultVO searchVO, ModelMap model, HttpServletResponse response) throws Exception {
        ...
        List resultList = faqManageService.selectFaqList(searchVO);
    ...
    @RequestMapping("/uss/olh/faq/FaqListDetailInqireJson.do")
	@ResponseBody
    public void	selectFaqListDetailJson(FaqManageVO faqManageVO,
            @ModelAttribute("searchVO") FaqManageDefaultVO searchVO,
