...
public class QnaManageVO extends QnaManageDefaultVO {
	 ...
	 * @return the String
	 */
	public String getWritngPssword() {
		return writngPssword;
	}
	 ...
	 */
	public void setWritngPssword(String writngPssword) {
		this.writngPssword = writngPssword;
	}
