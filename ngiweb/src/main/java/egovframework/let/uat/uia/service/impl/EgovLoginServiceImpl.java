...
public class EgovLoginServiceImpl extends EgovAbstractServiceImpl implements
    ...
    public LoginVO actionLoginByEsntlId(LoginVO vo) throws Exception {
    	...
    	// 3. 결과를 리턴한다.
    	if (loginVO != null && !loginVO.getId().equals("") && !loginVO.getPssword().equals("")) {
    		return loginVO;
    	} else {
    		loginVO = new LoginVO();
    	}
    ...
    public LoginVO actionLogin(LoginVO vo) throws Exception {
    	...
    	// 1. 입력한 비밀번호를 암호화한다.
    	String enpassword = EgovFileScrty.encryptPassword(vo.getPssword());
    	vo.setPssword(enpassword);
    ...
    public boolean searchPassword(LoginVO vo) throws Exception {
    	...
    	if (loginVO == null || loginVO.getPssword() == null || loginVO.getPssword().equals("")) {
    		return false;
    	}
